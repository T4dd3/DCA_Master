<%@ page import="dcamaster.model.*" %>
	...
	<div class="main">
		<form id="parametri" method="post" action="../request" onchange="calcolaPrevisione(); return false;"><table>
			<tr><td>Intervallo attuale: </td><td><%=(utente.getDca().getIntervalloInvestimento() != null) ? utente.getDca().getIntervalloInvestimento() : "Non impostato" %></td></tr>
			<tr><td>Budget attuale: </td><td><%=(utente.getDca().getBudget() != null) ? utente.getDca().getBudget() : "Non impostato" %></td></tr>
